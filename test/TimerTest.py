...
timertest_spec = ["implementation_id", "TimerTest", 
		 "type_name",         "TimerTest", 
...
# 
# 
class TimerTest(OpenRTM_aist.DataFlowComponentBase):
...
def TimerTestInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=timertest_spec)
    manager.registerFactory(profile,
                            TimerTest,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    TimerTestInit(manager)

    # Create a component
    comp = manager.createComponent("TimerTest")
